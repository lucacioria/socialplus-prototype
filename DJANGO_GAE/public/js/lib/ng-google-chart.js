                ...
                function draw() {
                    if (!draw.triggered && ($scope.chart != undefined)) {
                        ...
                        $timeout(function () {
                            ...
                            function asdf(e) {
                                $scope.callOnSelect($scope.chartWrapper.getChart().getSelection());
                            }
                            ...
                            if($scope.chartWrapper==null) {
                                ...
                                google.visualization.events.addListener($scope.chartWrapper, 'ready', function () {
                                    ...
                                    if($scope.callOnSelect) {
                                        google.visualization.events.addListener($scope.chartWrapper.getChart(), 'select', asdf);
                                    }
                                });
